...
export default function Login() {
    return (
        <div className="flex justify-center items-center h-[30rem] bg-gray-200">
            <Card className="w-96 px-7">
                <CardHeader
                    variant="gradient"
                    color="blue"
                    className="mb-4 grid h-28 place-items-center bg-sky-500 shadow-sky-500 relative bottom-7"
                >
                ...
                <CardFooter className="pt-0">
                    <Button variant="gradient" className="bg-sky-500 hover:shadow hover:shadow-sky-300" fullWidth>
                        Sign In
                    </Button>
                    <Typography variant="small" className="mt-6 flex justify-center pb-5">
                        ...
                        <Typography
                            ...
                            variant="small"
                            color="blue"
                            className="ml-1 font-bold text-sky-400 hover:text-sky-500"
                        >
                            Sign up
                        </Typography>
                    </Typography>
