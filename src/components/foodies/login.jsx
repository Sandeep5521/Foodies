        ...
        <div className="flex justify-center items-center h-fit dark:bg-black bg-gray-200 py-10 pt-28 px-5">
            <Card className="w-96 px-7">
                ...
                <CardBody className="flex flex-col gap-4 -mt-7">
                    ...
                    <div className="relative">
                        <input type="password" id="second_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 block w-full p-2.5 focus:bg-white focus:outline-none focus:border-red-500 peer" placeholder="" required />

                        <label htmlFor="second_name" className="cursor-text absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-0 origin-[0] bg-gray-50 peer-focus:bg-white px-2 peer-focus:px-2 peer-focus:text-red-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Password</label>

                    </div>
                    <div className="flex items-start mb-6">
                        <div className="flex items-center h-5">
                            <input id="remember" type="checkbox" value="" className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 accent-red-500" required />
                        </div>
