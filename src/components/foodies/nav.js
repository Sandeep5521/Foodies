...
export default function Example({ parent }) {
  ...
  return (
    <>
      <Navbar className={`fixed backdrop-blur-2xl bg-white bg-opacity-70 text-black inset-0 z-10 ${(openNav) ? 'h-[16rem]' : 'h-max'} max-w-full rounded-none py-2 px-4 lg:px-8 lg:py-4`}>
