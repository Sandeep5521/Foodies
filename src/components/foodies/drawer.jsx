            ...
            <div className={`${display} fixed top-12 bg-black backdrop-blur bg-opacity-50 w-screen`} id="menu">
                <div className="w-fit h-fit flex items-center justify-center">
                    <div className="space-y-1.5 py-2 px-3 text-lg w-screen">
                        <div className="rounded hover:bg-red-500 px-2 py-1"><a href="/">Home</a></div>
                        <div className="rounded hover:bg-red-500 px-2 py-1"><a href="/category">Categories</a></div>
                        <div className="rounded hover:bg-red-500 px-2 py-1"><a href="/search">Search</a></div>
